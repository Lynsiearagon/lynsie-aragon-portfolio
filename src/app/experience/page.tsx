export default function page() {
  return (
    <div className="flex flex-col p-12  h-full flex justify-center md:w-1/2">
      <h1 className="text-5xl text-center mb-8 mt-4 xl:mt-0">Experience</h1>
      ...
      <div className="my-12 grid gap-y-4">
        <div className="">
          ...
          <h3 className="py-4 text-lg flex flex-col md:flex-row justify-between">
        ...
        <div className="">
          ...
          <ul className="grid gap-y-2 text-justify pl-4 list-disc ml-4">
            ...
            <li>
              Managed court submissions and digital case fi les, ensuring
              compliance with strict deadlines
            </li>
          </ul>

          <h3 className="py-4 text-lg flex flex-col md:flex-row justify-between">
            Paralegal - Hach Rose Schirripa & Cheverie LLP - New York, NY
            <span>Jan 2021 – Apr 2022</span>
          </h3>
          <ul className="grid gap-y-2 text-justify pl-4 list-disc ml-4">
            <li>
