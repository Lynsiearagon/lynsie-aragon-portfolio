...
export const workHistory = [
  {
    ...
    description: [
      "Freelancer turned full time in October 2025",
      "Builds and optimizes full-scale websites for multiple T2 clients using Next.js, Tailwind CSS, and Directus, enhancing search visibility and user acquisition through SEO best practices",
      "Collaborates with cross-functional teams, including design, engineering, and product management, to align on project objectives and ensure timely, high-quality deliverables",
      "Translates Figma designs into responsive, accessible, and pixel-perfect components, maintaining design fi delity across devices and browsers",
    ],
    isCurrent: true,
  },
  {
    ...
    description: [
      "Developed internal applications for the USDA, enabling secure and seamless data exchange across all 50 states, U.S. territories, and the federal government",
      "Refactored and developed accessible, pixel-perfect user interfaces using JavaScript, React, and CSS, enhancing usability and overall user satisfaction",
      "Resolved frontend bugs, implemented robust error handling, and applied best practices to ensure scalable, maintainable, and high-performance applications",
    ],
    isCurrent: false,
  },
  {
  ...
  },
  {
    ...
    description: [
      "Litigation - Maintained case organization and prepared for trials, hearings, and depositions",
    ],
    isCurrent: false,
  },
  {
